...
export const TRACK_POST_CLICK_REQUEST = "TRACK_POST_CLICK_REQUEST";
export const TRACK_POST_CLICK_SUCCESS = "TRACK_POST_CLICK_SUCCESS";
export const TRACK_POST_CLICK_FAIL = "TRACK_POST_CLICK_FAIL";
